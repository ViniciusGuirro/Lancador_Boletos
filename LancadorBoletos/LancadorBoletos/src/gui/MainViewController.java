...
public class MainViewController implements Initializable {
	...
	@FXML
	private MenuItem menuItemBoleto;
	...
	@FXML
	public void onMenuItemBoletoAction() {
		loadView("/gui/BoletoList.fxml", (BoletoListController controller)->{
	...
	private synchronized <T> void loadView(String nomeCompleto, Consumer<T> initializingAction) {
		try {
